...
template<environment::PlanetPolicy Planet>
struct Spherical;
\end{lstlisting}
...
\section{Measurement Model Policy}

Measurement-model policies should follow the same ordering rule.
...
template<
    StateDefPolicy StateDef,
    MeasurementModelPolicy<StateDef> Measurement>
