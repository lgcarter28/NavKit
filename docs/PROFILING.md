...
- `output/logs/ecef_ins_gnss_lc_gyro_accel_bias_stationary_nominal/profile.csv`
- `output/logs/ecef_ins_gnss_lc_gyro_accel_bias_stationary_nominal/profile_run_manifest.json`
- `output/logs/ecef_ins_gnss_lc_gyro_accel_bias_stationary_nominal/profile.trace.json`
