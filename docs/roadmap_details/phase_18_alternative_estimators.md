# Phase 18 - Alternative Estimators
...
## Pass 18.1: sliding-window optimization
...
## Pass 18.2: factor-graph and incremental smoothing backend
...
## Pass 18.3: shared estimator interfaces
