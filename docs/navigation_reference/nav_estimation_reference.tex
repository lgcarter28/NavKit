...
\noindent The origin frame $o$ replaces earlier placeholder notation for the Navigation Reference Point. Sensor lever arms are written as $l_{os}^{b}$, meaning the position of sensor frame $s$ with respect to origin frame $o$, resolved in the body frame $b$.
