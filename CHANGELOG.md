...
- Split concrete IO log products and reusable log payload wrappers into focused `log_products` and `log_payloads` headers while keeping `RunLogProducts.hpp` as a narrow compatibility umbrella.
