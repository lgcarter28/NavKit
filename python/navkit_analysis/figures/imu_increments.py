...
def plot_imu_increment_cumsums(run: RunData, save: bool = True) -> list[plt.Figure]:
    ...
    for fig in [
        _plot_imu_family(
            ...
            title="IMU Full-Rate Run Cumulative Incremental Angle Snapshot: Truth/Ideal vs Measured",
        ...
        _plot_imu_family(
            ...
            title="IMU Full-Rate Run Cumulative Incremental Velocity Snapshot: Truth/Ideal vs Measured",
