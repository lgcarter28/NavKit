...
public:
    ...
    void log(const TrajectoryAutopilotVehicleLogPayload& payload)
    {
        ...
        m_csv.write_row(core::timestamp_seconds(data.t),
                        ...
                        data.autopilot_angular_rate_controller_response_b_radps.x(),
                        data.autopilot_angular_rate_controller_response_b_radps.y(),
                        data.autopilot_angular_rate_controller_response_b_radps.z(),
