...
/** Inspectable command/control/response values associated with one truth sample. */
struct TrajectoryDiagnostics
{
    ...
    /** Tracking errors use command minus final post-response, post-limit realized truth. */
