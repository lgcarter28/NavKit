...
using EcefInsGnssLcGyroAccelBiasDefault =
    EcefInsGnssLc<core::estimation::InsGyroAccelBiasStateDef,
                  ...
                  components::NullProfiling>;

static_assert(api::config::NavKitProductConfigPolicy<EcefInsGnssLcGyroAccelBiasDefault>);
...
using EcefInsGnssLcGyroAccelBiasDefaultConfig = products::EcefInsGnssLcGyroAccelBiasDefault;
