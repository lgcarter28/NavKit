...
struct DefaultEcefInsProcessNoise
{
    using ProcessNoise_t = core::estimation::EcefInsProcessNoise;
...
static_assert(core::estimation::EcefInsProcessNoiseConfigPolicy<DefaultEcefInsProcessNoise>);
