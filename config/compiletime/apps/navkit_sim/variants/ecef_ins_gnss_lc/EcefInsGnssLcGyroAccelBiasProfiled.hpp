...
#include "navkit/products/variants/ecef_ins_gnss_lc/EcefInsGnssLcGyroAccelBiasProfiled.hpp"
...
struct EcefInsGnssLcGyroAccelBiasProfiledConfig
{
    using NavKit = ::navkit::config::navkit::EcefInsGnssLcGyroAccelBiasProfiledConfig;
    ...
    using App = ::navkit::app_support::SimulationApp<EcefInsGnssLcGyroAccelBiasProfiledConfig>;
};
...
using SelectedConfig = apps::navkit_sim::EcefInsGnssLcGyroAccelBiasProfiledConfig;
